...
$scripts = [
    'master'     => __DIR__ . '/api-seeder/seed_master.php',
    'categories' => __DIR__ . '/api-seeder/seed_categories.php',
    'cohorts'    => __DIR__ . '/api-seeder/seed_cohorts.php',
    'courses'    => __DIR__ . '/api-seeder/seed_moodle.php',
    'grades'     => __DIR__ . '/api-seeder/seed_grades_messages.php',
];
